      ...
      <View style={styles.container}>
        ...
        <View style={styles.coopContainer}>
          ...
          <View style={styles.coopDetails}>
            ...
            <Text style={styles.address}>Amount: ₱ {trans?.amount}</Text>
            ...
            <Text  style={[
                ...
                { color: trans?.transactionStatus === "SUCCESS" ? "green" : 
                    ...
                    trans?.transactionStatus === "FAILED" ? "red" : "black" } // Default to black
          ...
          <View style={styles.buttonContainer}>
            ...
            >
              {isLoading ? (
                ...
                <Text style={styles.buttonApproveText}>WithDraw</Text>
              )}
            </TouchableOpacity>
