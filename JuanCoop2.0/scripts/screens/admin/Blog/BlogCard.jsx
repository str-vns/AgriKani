...
const BlogCard = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate("BlogList")} style={styles.backButton}>
    <Ionicons name="arrow-back" size={24} color="black" />
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={styles.date}>Published on: {new Date(blog.createdAt).toLocaleDateString()}</Text>
        <Text style={styles.content}>{blog.content}</Text>

       
        {/* External Website Link */}
        {blog.link && (
          <TouchableOpacity onPress={() => handleLinkPress(blog.link)} style={styles.linkButton}>
