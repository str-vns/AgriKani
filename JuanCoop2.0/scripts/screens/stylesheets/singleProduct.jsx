...
export default StyleSheet.create({
  ...
  productNameAndWishlistContainer: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "flex-start", // Aligns items closer together
    gap: 5, // Reduce spacing between price and icon (React Native 0.71+)
    marginBottom: 10, // Optional: Add spacing below the container
  },
  buttonContainer: {
    position: "absolute",
    bottom: 65,
