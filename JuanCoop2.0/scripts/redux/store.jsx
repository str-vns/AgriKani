...
import {
  ...
  coopdashboardReducer,
  overalldashboardReducer,
...
import {
  ...
  typeUpdateReducer,
  typeDeleteReducer,
} from "@redux/Reducers/typeReducers";
import {
  categoryListReducer,
...
import {
  driverApiReducer,
  driverListReducer,
  onlyApprovedDriverReducer,
  driverProfileReducer,
} from "@redux/Reducers/driverReducer";
import {
  deliveryListReducer,
  deliveryApiReducer,
  deliveryCompleteReducer,
  deliveryHistoryReducer,
} from "@redux/Reducers/deliveryReducers";
import {
  cancelledReducerApi,
  cancelledReducer,
} from "@redux/Reducers/cancelledReducer";
...
import { weatherCurrentReducer, weatherDailyReducer } from "./Reducers/weatherReducer";
